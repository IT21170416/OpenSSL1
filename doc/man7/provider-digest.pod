...
The OSSL_FUNC_digest_copyctx function is used in the EVP_MD_CTX_copy_ex function to speed up HMAC operations in the PBKDF2. This function is optional, and dupctx will be used if there is no EVP_MD_CTX_copy_ex function.
